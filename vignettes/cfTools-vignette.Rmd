...
abstract: >
  Cell-free DNA (cfDNA) in blood has emerged as an ideal surrogate for tumor biopsy. It can be obtained noninvasively, and provides a comprehensive land- scape of the heterogeneous genetic and epigenetic alterations in tumors. The major bottleneck of cfDNA application is bioinformatics analysis, because cfDNA possesses many unique properties that are not handled properly by general meth- ods. Here, we present a versatile informatics toolset for cfDNA data analysis to facilitate cfDNA-based cancer studies, including
  * Epigenetic mapping: sensitive detection of tumor-derived cfDNA from blood
  * Measuring tumor-derived cfDNA proportion and inferring the organ of origin noninvasive time-series monitoring
vignette: >
...
[2] Del Vecchio G, Li Q, Li W, Thamotharan S, Tosevska A, Morselli M, Sung K, Janzen C, Zhou X, Pellegrini M, Devaskar SU. Cell-free DNA methylation and transcriptomic signature prediction of pregnancies with adverse outcomes. *Epigenetics.* Oct 13:1-20; doi: 10.1080/15592294.2020.1816774. PMID: 33045922; PMCID: PMC8143248.
