...
* Section 3.1 `MergePEReads()`
  * Input: a standard (sorted) BED file of paired-end sequencing reads
    - How to prepare the BED file from the BAM file produced after reads alignment to the reference genome with *bismark*
...
* Section 3.2 `MergeCpGs()`
  ...
  *bismark methylation extractor*
    - How to use *bismark methylation extractor*
      ...
      `bismark_methylation_extractor -p --bedGraph --gzip --counts --buffer_size 11G \`
      `--genome_folder <genome_folder> --output <output_dir> <out_bam_sortn>`
