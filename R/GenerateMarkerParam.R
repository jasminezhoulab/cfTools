...
#'
#' @param x a data frame of methylation levels (e.g., beta values), where each row is a sample and each column is a marker.
#' @param sample.types a vector of sample types (e.g., tumor or normal, tissue types) corresponding to the rows of the data frame.
#' @param marker.names a vector of marker names corresponding to the columns of the data frame.
...
#' 
#' @return a data frame containing the paired shape parameters of beta distributions for markers and/or written to an output file.
#' 
#' @examples
#' ## input files
...
#' 
#' @export
GenerateMarkerParam <- function(x, sample.types, marker.names, output.file="") {
